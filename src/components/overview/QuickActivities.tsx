  ...
  return (
    <div className="mt-8 bg-[#1e5aa4] rounded-[30px] p-6 shadow-lg text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <button className="bg-white text-gray-800 rounded-xl py-4 px-4 flex flex-col items-center justify-center gap-2 hover:bg-gray-50 transition-colors shadow-sm">
